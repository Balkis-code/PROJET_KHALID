...
print("\n" + "=" * 80)
print("SOURCE 3: PFD_VALIDATION - APPROCHE CLASSIQUE (TOUS LES FICHIERS)")
print("=" * 80)

# ✅ FICHIERS AVEC EXTENSION .csv
pfd_files = [
    os.path.join(DATA_BASE_PATH, "pfd_validation", "t1.csv"),
    os.path.join(DATA_BASE_PATH, "pfd_validation", "t2.csv"),
    os.path.join(DATA_BASE_PATH, "pfd_validation", "t3.csv"),
    os.path.join(DATA_BASE_PATH, "pfd_validation", "US_Phone_Code.csv"),
]

results = []

for i, file_path in enumerate(pfd_files, 1):
    file_name = os.path.basename(file_path)
    print(f"\n[{i}/{len(pfd_files)}] {file_name}")
