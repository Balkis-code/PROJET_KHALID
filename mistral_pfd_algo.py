...
class AgentInLoopPFDDiscovery:
    ...
    def _convert(self, raw):
        ...
        for r in raw:
            ...
            # Convertir la notation texte en nom de colonne dérivée
    ...
    def discover(self, n_iterations=3):
        ...
        Args:
            n_iterations: Nombre d'itérations Mistral
